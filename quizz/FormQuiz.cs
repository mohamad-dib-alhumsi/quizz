...
namespace quizz
{
    public partial class FormQuiz : Form
    {
        ...
        private void LoadQuestions(int? categoryId = null, int desiredCount = 10)
        {
            ...
            // 1️⃣ Vragen ophalen (random met NEWID)
            ...
            var paramList = new List<SqlParameter>
    {
        ...
        new SqlParameter("@cat", categoryId.HasValue ? (object)categoryId.Value : DBNull.Value)
            ...
            // 2️⃣ Voor elke vraag: antwoorden ophalen
            foreach (System.Data.DataRow row in dtQuestions.Rows)
            {
                ...
                // Haal antwoorden van deze vraag
                var dtAnswers = Db.ExecuteSelect("SELECT AnswerId, Text, IsCorrect FROM Answers WHERE QuestionId = @qid",
        ...
        private void ShowQuestion()
        {
            ...
            // Shuffle answers zodat niet altijd Antwoord1 correct is
            ...
            // Sla correct antwoord op in Tag van de button
        ...
        private void EndQuiz()
        {
            ...
            if (place != -1)
                MessageBox.Show($"Gefeliciteerd! Je staat op plaats {place} in de top 10.");
            else
                MessageBox.Show($"Je eindscore is {_score}.");
        }
